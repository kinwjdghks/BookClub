...
const {kakao} = window;
const Kakaomap = ({place,searchinput}) =>{
    ...
    useEffect(()=>{
        ...
        const displayMarker = (place) => {
            ...
            kakao.maps.event.addListener(marker, 'click', function() {
                ...
                setSelectedCoor({Lat: place.y, Lng:place.x});
            });
        }
        ...
        const pos =  (place==null) ? new kakao.maps.LatLng(37.49798640766797,127.02764966969421) : new kakao.maps.LatLng(place[0],place[1]);
        const options = {
            center: pos,
            level: 6
        }
