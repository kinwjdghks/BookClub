...
const Kakaomap = ({place,placename,searchinput,onSearch}) =>{
    ...
    useEffect(()=>{
        ...
        const pos =  (place==null) ? new kakao.maps.LatLng(37.49798640766797,127.02764966969421) : new kakao.maps.LatLng(place.y,place.x);
        const options = {
            center: pos,
            level: 6
        }
        ...
        if(place!=null) //주소 있을 때 (디스플레이 모드)
            ...
            setTimeout(()=>{
            const pos_ =  new kakao.maps.LatLng(37.49798640766797,127.02764966969421);
            const options = {
                center: pos_,
                level: 6
            }
